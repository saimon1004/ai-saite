  ...
  caseStudies: [
    {
      ...
      interview: {
        ...
        quote: "採用サイトのリニューアルを任されたとき、最初は制作会社への外注を考えていました。でも見積もりは数百万円、修正のたびに追加費用がかかると聞いて悩んでいたところ、この研修を知りました。受講後はClaude Codeに日本語で指示するだけでサイトが形になっていくのが衝撃的で、デザイン修正も「ここをもう少し明るく」と伝えるだけ。外注と比べてトータルコストは大幅に抑えられましたし、自分たちで即座に更新できるのも大きいです。公開後は応募数が前年比137%に増え、今では他部署からも「うちのページも作って」と相談が来ています。",
      },
    },
    {
      number: "02",
